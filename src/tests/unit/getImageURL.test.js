const { getSignedUrl } = require('../../controllers/getImageURL'); // Подключаем функцию для тестирования
...
describe('getImageURL function', () => {
    it('should return a signed URL when cardID is provided', async () => {
        ...
        sinon.assert.calledWithExactly(s3.getSignedUrl, 'getObject', sinon.match.object);
